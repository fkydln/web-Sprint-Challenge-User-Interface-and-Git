...
5. Explain why git is valuable to a team of developers.
    ...
    There are so many advantages of using GitHub and Git Bash command line. Developers will be able to develope a part of a program and commit & push it regularly to keep updated with old versions. Developers will be able to restore old version in case have a bug that they can't figure out how to solve or just decide to keep older versions for preference. Also by creating pull requests, the engineer manager will be notified and the manager can see differences line by line on GitHub comparison before a developer merge it himself/herself. 
